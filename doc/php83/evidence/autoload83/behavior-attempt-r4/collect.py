...
def validate(body,case,runtime,variant,exitcode,stderr,hashes,stdout=''):
    ...
    if case.startswith('fatal-'):
        ...
        require(body['fatal']=={'severity':64,'file':target,'line':{'hp':17,'core':188,'cli':107}[family(case)],'message_sha256':hashlib.sha256(b'__autoload() is no longer supported, use spl_autoload_register() instead').hexdigest()},'Wrong fatal source/line/message')
