...
The optional [Kaltura Console](kaltura-console/README.md) provides an embedded
Vue UI and local user management in one Go binary. It talks directly to the
Kaltura `api_v3` API; it does not replace the KMC or Admin Console.
