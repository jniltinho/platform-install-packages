...
ROOT='/home/vagrant/php-exp3-regression'
HTTP_EXPECTED=[]
for kind in (0,2):
...
def main():
 ...
 db={'datadir':'/tmp/kaltura-pdo-mysql.'+token,'unit':'php83-exp3-api-'+token}
 records=[];cleanup={}
 try:
 ...
 comparisons=[{'runtime':r['runtime'],'matches_baseline':baseline['returncode']==0 and r['returncode']==0 and r['stdout']==baseline['stdout']} for r in records if r['tree']=='exp3']
