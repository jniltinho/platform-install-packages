...
[[ "$number:${1:-}" != 74:exp7 ]] || exit 64
case "${1:-}" in
 original) tree=/home/vagrant/php${number}-audit/packaged/opt/kaltura/app ;;
 exp6) tree=/home/vagrant/php-exp6-regression/source/server-Rigel-18.20.0 ;;
 exp7) tree=/home/vagrant/php-exp7-regression/source/server-Rigel-18.20.0 ;;
 *) exit 64 ;;
esac
...
scripts=/home/vagrant/php-exp7-regression/tests
if [[ "$2" == debug-pdo* ]]; then
