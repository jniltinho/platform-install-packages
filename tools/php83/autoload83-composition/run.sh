...
case "$3" in hp-append|hp-prepend|hp-throw|hp-repeat|core-repeat|cli-append|cli-prepend|cli-throw-front|cli-throw-tail|cli-repeat) ;; *) exit 64 ;; esac
[[ "$1:$2" != 83:original ]] || exit 64
stage=/home/vagrant/php-autoload83-composition-r1
source_stage=/home/vagrant/php-autoload83-r2
exec sudo systemd-run --quiet --wait --pipe --collect \
 ...
 -p "BindReadOnlyPaths=$source_stage/$2:/audit/source $stage/probe.php:/audit/probe.php $source_stage/fixtures:/audit/fixtures $stage/fixtures:/audit/composition-fixtures /home/vagrant/php-mysql-probe/runtime83:/audit/runtime83" \
