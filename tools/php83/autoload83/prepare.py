...
STAGE='/home/vagrant/php-autoload83-r2'
...
def prepare(archive,dest):
    ...
    with zipfile.ZipFile(archive) as z:
        ...
        for info in files:
            ...
            if str(rel).startswith(('vendor/htmlpurifier/','vendor/symfony/','vendor/symfony-data/','alpha/config/cache/')) or str(rel) in ('alpha/config/kConf.php','alpha/config/kConfCacheManager.php','infra/kEnvironment.php','infra/general/iniUtils.php'):
    ...
    report={'zip_sha256':PIN,'subset':'Three complete vendor subtrees plus real kConf/cache dependency files from exp10, not full application','files_per_tree':len(selected),'patches':rows,'stage':STAGE,'hashes':hashes}
