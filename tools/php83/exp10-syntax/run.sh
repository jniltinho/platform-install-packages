...
stage=/home/vagrant/php-candidate-syntax-exp10
...
exec sudo systemd-run --quiet --wait --pipe --collect \
 ...
 -p "BindReadOnlyPaths=$stage/tools:/audit/tools $stage/exp9.zip:/audit/exp9.zip $stage/exp10.zip:/audit/exp10.zip $stage/exp9/server-Rigel-18.20.0:/audit/exp9 $stage/exp10/server-Rigel-18.20.0:/audit/exp10" \
