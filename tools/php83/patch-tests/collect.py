...
parser.add_argument('--case', action='append', choices=['doc-comment-cache', 'doc-comment-consumer', 'doc-comment', 'api-bootstrap', 'symfony-bootstrap', 'symfony-yaml', 'symfony', 'registry', 'registry-bootstrap', 'registry-action-stack', 'legacy-json', 'zend-json', 'analytics-partner', 'debug-pdo', 'debug-pdo-logging', 'debug-pdo-stringify'])
...
if any(c.startswith('debug-pdo') or c in ('doc-comment-consumer', 'analytics-partner', 'symfony-yaml', 'symfony-bootstrap', 'api-bootstrap') for c in cases) and 'minimal' in modes:
...
report = {'environments': environments,
          ...
          for p in [folder / 'doc-comment-cache.php', folder / 'doc-comment-legacy-cache.json', folder / 'doc-comment-consumer.php', folder / 'doc-comment.php', folder / 'behavior.php', folder / 'api-bootstrap.php', folder / 'symfony.php', folder / 'registry-bootstrap.php', folder / 'registry-action-stack.php', folder / 'analytics-partner.php', folder / 'debug-pdo.php', folder / 'debug-pdo-edges.php', folder / 'debug-pdo-logging.php', folder / 'run-one.sh', Path(__file__)]},
