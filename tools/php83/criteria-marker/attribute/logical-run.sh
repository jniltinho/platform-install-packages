...
case "$1" in original|attribute) ;; *) exit 64;; esac
...
base=/home/vagrant/php-criteria-marker-logical-v1
cd "$base"
...
sudo systemd-run --quiet --wait --pipe --collect \
 ...
 -p "BindReadOnlyPaths=$base:/audit/probe /home/vagrant/php-criteria-marker-attribute-v1:/audit/source" -p MemoryMax=128M -p RuntimeMaxSec=30 \
 "$php" -n "${extra[@]}" -d display_errors=stderr -d log_errors=0 -d allow_url_fopen=0 -d allow_url_include=0 \
 /audit/probe/logical.php "$1"
