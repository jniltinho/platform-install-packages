...
case "$2" in previous|candidate) ;; *) exit 64;; esac
extra=""
if [[ "$2" == candidate ]]; then extra=" /home/vagrant/php-pdo-bool/PropelPDO-bool-setAttribute.php:/audit/app/vendor/propel/util/PropelPDO.php /home/vagrant/php-pdo-bool/KalturaStatement-bool-results.php:/audit/app/alpha/apps/kaltura/lib/db/KalturaStatement.php"; fi
...
exec sudo systemd-run --quiet --wait --pipe --collect \
 ...
 -p "BindReadOnlyPaths=$tree:/audit/app $scripts:/audit/tests /home/vagrant/php-pdo-bool:/audit/probe /home/vagrant/php-mysql-probe/runtime83:/audit/runtime83 $3:/audit/db$extra" \
 /usr/bin/env "PHP83_BOOL_VARIANT=$2" "PHP83_PROBE_DATADIR=$3/data/" "$runtime" "${ini[@]}" -d log_errors=0 -d allow_url_fopen=0 -d allow_url_include=0 \
