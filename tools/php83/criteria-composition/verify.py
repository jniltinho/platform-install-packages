...
EXPECTED={'prior.php','candidate.php','criteriaFilter.php','filter.php','returns.php','run.sh','verify.py','myCriteria.php','IKalturaDbQuery.php','KalturaCriteria.php','legacy.json'}
def verify(base,pin):
    ...
    m=json.loads(raw)
    if {f.name for f in base.iterdir()}!=EXPECTED|{'identities.json'}: raise ValueError('Unexpected stage entry')
